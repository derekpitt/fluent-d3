System.register(['./line-builder', './chart-with-axis-builder'], function (_export) {
    ...
    return {
        setters: [function (_lineBuilder) {
            LineBuilder = _lineBuilder.LineBuilder;
        }, function (_chartWithAxisBuilder) {
            ChartWithAxisBuilder = _chartWithAxisBuilder.ChartWithAxisBuilder;
        }],
        execute: function () {
            LineGraphBuilder = (function (_ChartWithAxisBuilder) {
                ...
                _createClass(LineGraphBuilder, [{
                    ...
                    value: function withLine(configurer) {
                        var newLineBuilder = new LineBuilder();
            ...
            })(ChartWithAxisBuilder);

            _export('LineGraphBuilder', LineGraphBuilder);
        }
    };
});