System.register(['axis-builder', 'chart-builder'], function (_export) {
    'use strict';

    var AxisBuilder, ChartBuilder, ChartWithAxisBuilder;
    ...
    return {
        setters: [function (_axisBuilder) {
            AxisBuilder = _axisBuilder.AxisBuilder;
        }, function (_chartBuilder) {
            ChartBuilder = _chartBuilder.ChartBuilder;
        }],
        execute: function () {
            ChartWithAxisBuilder = (function (_ChartBuilder) {
            ...
            _export('ChartWithAxisBuilder', ChartWithAxisBuilder);
        }
    };
});