(function (global, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['exports', './chart-builder', 'd3'], factory);
    } else if (typeof exports !== 'undefined') {
        factory(exports, require('./chart-builder'), require('d3'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.chartBuilder, global.d3);
        global.sparkBuilder = mod.exports;
    }
})(this, function (exports, _chartBuilder, _d3) {
    'use strict';
