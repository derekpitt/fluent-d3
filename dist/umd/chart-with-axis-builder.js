(function (global, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['exports', 'axis-builder', 'chart-builder'], factory);
    } else if (typeof exports !== 'undefined') {
        factory(exports, require('axis-builder'), require('chart-builder'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.axisBuilder, global.chartBuilder);
        global.chartWithAxisBuilder = mod.exports;
    }
})(this, function (exports, _axisBuilder, _chartBuilder) {
    'use strict';
